...
export const SYMBIOSIS_DEFINITIONS: Record<string, SymbiosisDefinition> = {
  ...
  parasitism: {
    label: 'Parasitism — one feeds on another',
  ...
  predation: {
    label: 'Predation — one hunts another',
  ...
  competition: {
    label: 'Competition — rivals for the same resource',
  ...
  commensalism: {
    label: 'Commensalism — one benefits, other unaffected',
  ...
  amensalism: {
    label: 'Amensalism — one suppresses another',
